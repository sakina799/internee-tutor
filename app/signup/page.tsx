      ...
      <div className="relative flex items-center justify-center px-8 py-10 max-w-6xl mx-auto">
        ...
        <div className="flex-1 flex justify-center md:justify-start">
          <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-sm">
            ...
            <p className="text-sm text-[#03045E]/70 mb-6">Create your account</p>

            <form onSubmit={handleSignup} className="space-y-4">
              <div>
                <label className="text-xs text-[#03045E]/70 mb-1 block">Full name</label>
                <input
                  type="text"
            ...
            <p className="text-xs text-[#03045E]/70 text-center mt-6">
              ...
              <a href='/login' className='text-[#00B4D8] font-medium'>
                Log in
              </a>
            </p>
          </div>
